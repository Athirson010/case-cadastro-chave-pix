...
class ChavePixValidacaoCNPJTest {
    ...
    public void testCNPJValidoComPontuacao() {
        ...
        Assertions.assertDoesNotThrow(() -> chavePixValidacaoCNPJ.validarCaracteristicas(cnpjValido));
    }
    ...
    public void testCNPJInvalidoComPontuacaoErrada() {
        ...
        assertThrows(ValidacaoException.class, () -> chavePixValidacaoCNPJ.validarCaracteristicas(cnpjInvalido));
    }
